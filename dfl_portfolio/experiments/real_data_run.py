...
def main() -> None:
    ...
    if args.delta == 0.0 and any(m == "ipo" for m in model_list):
        raise ValueError("delta=0 is not supported for IPO closed-form model (ipo). "
                         "Use delta>0 or remove 'ipo' from --models.")
